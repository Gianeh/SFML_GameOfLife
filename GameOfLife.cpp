...
void GameOfLife::loadConfig(){
		...
		if (input == "manual" || input == "Manual"){
			std::cout << std::endl << "Insert number of Rows: ";
			std::cin >> R;
			std::cout << std::endl << "Insert number of Columns: ";
			std::cin >> C;
			std::cout << std::endl << "Insert size of Squares: ";
			std::cin >> Res;
			std::cout << std::endl << "Insert Frame rate limit: ";
			std::cin >> fps;
		}else{
